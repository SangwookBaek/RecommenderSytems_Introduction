...
class My_PopularityRecommender(BaseRecommender):
    def recommend(self, dataset: Dataset, **kwargs) -> RecommendResult:
        # 평갓값의 임곗값
        minimum_num_rating = kwargs.get("minimum_num_rating", 200)
        print(minimum_num_rating)
...
if __name__ == "__main__":
    ...
    My_PopularityRecommender(data_loader_str='arrow').run_sample(minimum_num_rating=50)
    My_PopularityRecommender(data_loader_str='arrow').run_sample(minimum_num_rating=200)
